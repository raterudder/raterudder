...
func TestHistory(t *testing.T) {
	...
	mockSBase.On("GetSettings", mock.MatchedBy(func(ctx context.Context) bool { return ctx != nil }) /* Ensure a non-nil valid context is passed */, types.SiteIDNone).Return(types.Settings{UtilityProvider: "test"}, types.CurrentSettingsVersion, nil)
...
func TestHandleHistoryEnergy(t *testing.T) {
	...
	t.Run("Success", func(t *testing.T) {
		...
		mockS.On("GetSettings", mock.MatchedBy(func(ctx context.Context) bool { return ctx != nil }) /* Ensure a non-nil valid context is passed */, types.SiteIDNone).Return(types.Settings{
		...
		// Energy History
		mockS.On("GetEnergyHistory", mock.MatchedBy(func(ctx context.Context) bool { return ctx != nil }) /* Ensure a non-nil valid context is passed */, types.SiteIDNone, startQuery, endQuery).Return([]types.DailyEnergyStats{
		...
		// Weather
		mockS.On("GetWeather", mock.MatchedBy(func(ctx context.Context) bool { return ctx != nil }) /* Ensure a non-nil valid context is passed */, types.SiteIDNone, actualStart, actualEnd).Return([]types.Weather{
			{
				TSDayStart: d,
	...
	t.Run("Energy Cache Control Today", func(t *testing.T) {
		...
		mockS.On("GetEnergyHistory", mock.MatchedBy(func(ctx context.Context) bool { return ctx != nil }) /* Ensure a non-nil valid context is passed */, types.SiteIDNone, startEnergy, endEnergy).Return([]types.DailyEnergyStats{
			{
				TSDayStart: todayUTC,
		...
		mockS.On("GetWeather", mock.MatchedBy(func(ctx context.Context) bool { return ctx != nil }) /* Ensure a non-nil valid context is passed */, types.SiteIDNone, startWeather, endWeather).Return([]types.Weather{
			{
				ForecastHours: []types.HourlyWeather{
