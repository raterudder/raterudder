...
describe('Forecast Page', () => {
    ...
    it('renders tomorrow comparison charts when solar1hForecast or solar15mForecast is present', async () => {
        ...
        (fetchModeling as any).mockResolvedValue({
            ...
            solar15mForecast: [
                {
                    tsHourStart: '2026-02-12T12:00:00Z',
                    improvedSolarGeneration: 1.6,
                    unclippedSolarGeneration: 1.9,
                }
            ]
        });
        ...
        await waitFor(() => {
            ...
            expect(screen.getByText('15-Minute Self-Calculated Solar (15m Forecast) (kWh)')).toBeInTheDocument();
        });
    });
