            ...
            <form onSubmit={handleSubmit}>
                ...
                <div className="submit-section">
                    ...
                    <button type="submit" className="save-button" disabled={isSaving}>
                        {isSaving ? (
                            <>
                                <svg className="spinner" aria-hidden="true" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <circle className="spinner-track" cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="4" opacity="0.25"></circle>
