...
## 2024-06-02 - DateSelector Accessibility
**Learning:** For interactive date navigators, dynamically updated content like the displayed date is often missed by screen readers unless announced. Also, wrapping the controls in a role="group" provides context.
**Action:** Always add aria-live="polite" and aria-atomic="true" to dynamic text elements like dates, and wrap associated navigation controls in a semantic or aria group.
